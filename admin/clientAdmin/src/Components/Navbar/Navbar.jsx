...
function Navbar() {
    return (
        <div className='bg-indigo-300/50 h-screen fixed w-48 top-0 left-0 shadow-lg rounded-e-3xl z-50 flex flex-col items-center justify-start gap-3 overflow-hidden'>
            <h1 className='py-2 w-full text-blue-950 text-2xl font-poppins font-bold mt-10 mb-2 text-center underline'>VRC Check</h1>
